...
class _HospitalDetailPageState extends State<HospitalDetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: StreamBuilder(
            stream: _firestoreDBDoctorList.doc(id).collection("doctorList").snapshots(),
            ...
            return ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    Map<String, dynamic> map = (snapshots.data! as QuerySnapshot).docs[index]
                                        ...
                                        FlatButton(
                                          onPressed: () async {
                                            Map<String, dynamic> doctorList = {
                                              ...
                                              "doctorPost": map['doctorPost'],
                                              "doctorSpeciality": map['doctorSpeciality'],
                                              "doctorEducation": map['doctorEducation'],
                                              "hospitalUid": id
                                            };
                                            _firestoreDBDoctorList.doc(_auth.currentUser!.uid).collection('appointmentRequestedDoctorList').add(doctorList);

                                            var _firestore = FirebaseFirestore.instance.collection("users").doc(_auth.currentUser!.uid);
                                                DocumentSnapshot snapshot = await _firestore.get();
